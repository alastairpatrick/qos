...
bool qos_acquire_mutex(struct qos_mutex_t* mutex, qos_tick_count_t timeout);
...
bool qos_wait_condition_var(struct qos_condition_var_t* var, qos_tick_count_t timeout);
